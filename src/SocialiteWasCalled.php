...
use Lijinhua\HyperfSocialite\One\AbstractProvider as SocialiteOAuth1AbstractProvider;
use Lijinhua\HyperfSocialite\Two\AbstractProvider as SocialiteOAuth2AbstractProvider;
...
class SocialiteWasCalled
{
    ...
    public function extendSocialite(SocialiteManager $socialite, $providerClass, $oauth1Server = null)
    {
        ...
        $socialite->extend(
            ...
            function () use ($socialite, $providerName, $providerClass, $oauth1Server) {
                return $this->buildProvider($socialite, $providerName, $providerClass, $oauth1Server);
            }
        );
    }
    ...
    protected function buildOAuth1Provider(SocialiteManager $socialite, $providerClass, $providerName, $oauth1Server)
    {
        ...
        $provider = new $providerClass(
            \Hyperf\Support\make(RequestInterface::class), new $oauth1Server($configServer)
        );
    ...
    {
        return \Hyperf\Support\make(ConfigInterface::class)->get(sprintf('socialite.config.%s', $providerName), []);
    }
